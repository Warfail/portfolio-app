...
async function loadExperiences() {
    try {
        ...
        if (!experiences || experiences.length === 0) {
            container.innerHTML = '<p style="text-align:center;color:var(--body-text-muted);">No experiences to display yet.</p>';
            return;
        }
            ...
            <div class="timeline-item">
                <div class="timeline-header">
                    <div class="company-photo-wrapper">
                        ${exp.image_url ? 
                            `<img src="${exp.image_url}" alt="${exp.company}" class="experience-photo">` :
                            `<div class="experience-photo-placeholder"><i class="fas fa-building"></i></div>`
                        }
        ...
        document.getElementById('experience-container').innerHTML = '<p style="text-align:center;color:var(--body-text-muted);">Failed to load experiences.</p>';
    }
}
// ==================== Load Projects ====================
